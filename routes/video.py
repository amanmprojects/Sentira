...
from config import client, DOWNLOADER_BASE_URL
...
@router.post("/reel", response_model=ReelAnalysis)
async def analyze_reel(request: ReelAnalysisRequest):
    """
    Analyze an Instagram reel by URL and return structured analysis.
    ...
    4. Returns detailed analysis including characters, issues, and transcript
    """
