            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                >
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        <Activity className="text-aurora-cyan" size={24} />
                        <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tighter">
                            Sentiment <span className="aurora-text">Analysis</span>
                        </h1>
                    </div>
                    <p className="text-white/40 text-sm">
                        Analyze emotional tone from your {input.modality} content
                    </p>
                </motion.header>
                ...
                >
                    ...
                    <span className="inline-block mt-2 px-3 py-1 rounded-lg bg-aurora-cyan/10 text-aurora-cyan text-[10px] font-black uppercase tracking-widest">
                        {input.modality}
                    </span>
                </motion.div>
                ...
                >
                    <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-aurora-cyan/10 flex items-center justify-center">
                        <Activity className="text-aurora-cyan" size={32} />
                    </div>
                    <h2 className="text-xl font-black uppercase tracking-tight mb-2">
                        Analysis In Progress
                    </h2>
                    <p className="text-white/40 text-sm max-w-md mx-auto">
                        Sentiment analysis results will appear here. Connect your backend API to process the content.
                    </p>
                </motion.div>
            </div>
        </div>
